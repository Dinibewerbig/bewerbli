<template>
  <section class="container">
    ...
    <div class="bs-callout-info bs-callout">
      ...
      <p>
        The URL uses <a
          href="https://github.com/googleapis/googleapis/blob/master/google/api/http.proto"
          target="_blank"
        >
    ...
    <div class="jumbotron well">
      <button type="button" class="btn btn-primary" @click="showPeopleMyConnections">
        Show My Connections
      </button>
      <div v-show="isShow" id="content" class="lead">
        <p class="lead">
          Connections:
        </p>
        <ul>
          <li v-for="(connection, index) in google.people_my.connections" :key="index">
            {{ connection }}
          </li>
        </ul>
      </div>
