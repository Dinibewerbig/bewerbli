  ...
  <div class="w-full max-w-2xl mx-auto  px-10 md:px-4">
    <div class="flex flex-col flex-col-reverse md:flex-row ">
      <div class="flex-1 md:w-1/3 text-xl leading-normal tracking-wide text-black mx-8">
        <div class="">
          <div class=" tracking-normal text-4xl mb-8 font-light">
            Erstelle ein neues Konto oder melde dich an, bevor du den Fragebogen ausfüllst   
          </div>
            ...
            <form v-if="showLoginForm" @submit.prevent>
              <div class="flex flex-row flex-wrap">
                <div class="w-1/2 pr-8">
                  ...
                  <button
                    class="button btn btn--primary  tracking-wider"
                    @click="login"
                  >
                    Einloggen
                  </button>
                ...
                <div class="w-1/2">
                  <div class="flex mx-8">
                    ...
                    <div class="w-full ">
                      <div class=" ml-4   w-full  content-center flex" @click="googleSignIn">
                        <svg
                          class=""
                          width="52"
                          height="52"
                      ...
                      <div class="ml-4  w-full content-center flex" @click="facebookSignIn">
                        <svg
                          class=""
                          width="52"
                          height="52"
          ...
          <form v-if="!showLoginForm && !showForgotPassword" @submit.prevent>
            <div class=" ">
              <div class="w-full">
                <div class="mt-8 w-full text-1xl " />
              </div>
              <div class="mb-6">
                <input
                  id="email2"
              ...
              <div class="flex flex-row">
                <button
                  class=" btn btn--primary tracking-wider"
                  @click="signup"
                >
                  Jetzt anmelden
                </button>
                <div class="ml-12 self-center tracking-normal text-xl font-light">
                  oder
                </div>
