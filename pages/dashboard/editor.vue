        ...
        >
          <div class>
            <div v-if="currentUser" class="flex items-center mb-8">
              <div id="documenteditor_title_contentEditor" class="ml-3 flex-1 single-line">
                <nuxt-link
                  to="/dashboard/fragebogen/dokumente"
                  class="text-info1 no-underline text-sm text-white leading-tight"
                >
                  {{ userProfile.name }}
                </nuxt-link>
              </div>
...
export default {
  ...
  methods: {
    ...
    openBtnClick: function() {
      this.$refs.doceditcontainer.ej2Instances.documentEditor.uploadDocument.click()
    },
