  ...
  <div class="control-section">
    <div class="sample-container">
      <div class="default-section">
        <div id="documenteditor_titlebar" ref="de_titlebar" class="e-de-ctn-title flex justify-between ">
          <div class="">
          ...
          <div>
            ...
            />
            <nuxt-link class="no-underline text-white inline-block  " to="/">
              Zurück
            </nuxt-link>
          </div>
        </div>
  ...
  methods: {
    ...
    openExportDropDown: function() {
      ...
      document
        ...
        .setAttribute(
          'title',
          'Download a copy of this document to your computer as an PDF file.'
        )
    },
