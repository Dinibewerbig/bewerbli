  ...
  <div class="checkout max-w-wp-pusher mx-auto">
    <div class="panel flex flex-col md:flex-row mb-8 shadow-lg">
      <div class="panel-left w-full md:w-2/3 bg-white rounded-l">
        <form action="#">
          <h1 class="text-3xl font-normal p-10 border-b border-solid border-grey-light">
            Checkout
          </h1>
          <div class="p-10 pt-8 border-b border-solid border-grey-light">
            <div class="flex items-center mb-4">
              <div class="border-2 border-solid border-blue-wp-pusher py-2 px-3 rounded-full font-bold mr-2 text-blue-wp-pusher">
                1
              </div>
              <h2 class="text-lg">
            ...
            <div class="flex items-center justify-center mb-8">
              ...
              <div>
                ...
                <span class="text-grey-darker">
                  Don't hesitate to <a href="#" class="text-grey-darker underline">
                    contact support
                  </a>!
                </span>
              </div>
      ...
      <div class="panel-right w-full md:w-1/3 bg-blue-wp-pusher text-white rounded-r">
        <div class="p-10">
          ...
          <div class="mb-4">
            ...
            <span class="text-5.5xl font-light lh-fix">
              99
            </span>
            <span class="text-lg">
              / year
                  ...
                  <g transform="translate(-887.000000, -489.000000)" fill="#B9F5FF">
                    <g transform="translate(262.000000, 186.000000)">
                      <g transform="translate(580.000000, 0.000000)">
                        <g transform="translate(44.000000, 42.000000)">
                          <g transform="translate(1.000000, 188.000000)">
                            <path id="Combined-Shape-Copy-2" d="M10,93 C4.4771525,93 0,88.5228475 0,83 C0,77.4771525 4.4771525,73 10,73 C15.5228475,73 20,77.4771525 20,83 C20,88.5228475 15.5228475,93 10,93 Z M10,91 C14.418278,91 18,87.418278 18,83 C18,78.581722 14.418278,75 10,75 C5.581722,75 2,78.581722 2,83 C2,87.418278 5.581722,91 10,91 Z M7.70710678,82.2928932 L9,83.5857864 L12.2928932,80.2928932 C12.6834175,79.9023689 13.3165825,79.9023689 13.7071068,80.2928932 C14.0976311,80.6834175 14.0976311,81.3165825 13.7071068,81.7071068 L9.70710678,85.7071068 C9.31658249,86.0976311 8.68341751,86.0976311 8.29289322,85.7071068 L6.29289322,83.7071068 C5.90236893,83.3165825 5.90236893,82.6834175 6.29289322,82.2928932 C6.68341751,81.9023689 7.31658249,81.9023689 7.70710678,82.2928932 Z" />
                          </g>
                        </g>
                      </g>
                    </g>
          ...
          <div class="mb-10 pb-2">
            <div class="mb-2">
              Need <span class="font-bold">
                20
              </span> clients?
            </div>
            <a href="#" class="text-white font-bold border-b-2 border-solid border-blue-light">
              Switch to the Agency plan.
            </a>
          </div>

          <div class="border-b border-solid border-blue-light" />

          <div class="testimonial pt-10 text-lg italic leading-normal mb-4">
            FTP is horrible to deal with. <span class="font-bold">
              WP Pusher
            </span> solves that issue, and the customer support is awesome!
          </div>

          <div class="flex items-center">
            <img src="https://s3-us-west-2.amazonaws.com/s.cdpn.io/195612/wppusher_avatar.png" alt="avatar" class="rounded-full mr-2">
    ...
    <div class="copyright text-grey-dark text-center text-sm mb-8">
      &copy; 2018 WP Pusher IVS &middot; <a href="#" class="text-blue-wp-pusher">
        Terms of Service
      </a>
    </div>
  </div> <!-- end checkout -->
