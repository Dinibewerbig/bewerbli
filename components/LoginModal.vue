        ...
        <form v-if="showLoginForm" @submit.prevent>
          ...
          <div class="card-body w-full">
            <div class="mb-6">
              <input
                ...
                class="form-input border-info3 text-info3"
                type="text"
            ...
            <div
              class="btn h-12 mb-12 mx-auto bg-info3 uppercase w-1/2 font-medium text-white p-4 tracking-wider"
              @click="login"
            >
              anmelden
            </div>
          ...
          <div class="card-footer">
            <div class="text-center flex">
              <a
                class="mr-2  text-info2 light no-underline"
                @click="toggleForm"
              >
                Hast du noch kein Konto?
              </a>
              <a
                class="ml-2 text-info3 light no-underline"
