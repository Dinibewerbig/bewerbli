<template>
  <section>
    <section id="key-benefits" class="container-lg">
      <img src="assets/download.png" style="width:100%" class="logo">
      <h1 class="common-BodyTitle">
        Sei schneller als die anderen
      </h1>
      <p
        class="common-BodyText"
      >
        Die Lehrstellensuche beginnt manchmal bereits vor den Sommerferien. Die tollen Lehrstellen werden bereits früh vergeben. Je früher du dich bewirbst, desto grösser sind deine Chancen auf eine solche Stelle.
      </p>

      <span id="customization-fallback-icon" />
      <img src="assets/download.png" style="width:100%" class="logo">

      <h1
        class="common-BodyTitle"
      >
        Dein Brief ist wirkungsvoll strukturiert und verständlich formuliert
      </h1>
      <p
        class="common-BodyText"
      >
        Dein Brief ist so gut formuliert, dass er Lehrlingsverantwortliche überzeugt. So kannst du deine Lehrer und Eltern entlasten.
      </p>
      ...
      <h1 class="common-BodyTitle">
        Personalisiere deinen Brief
      </h1>
      <p class="common-BodyText">
        Dein Bewerbungsbrief sollte persönlich gestaltet sein und von dir erzählen. Unser ausgeklügelter Fragebogen hilft dir dabei die richtigen Bereiche abzudecken.
        <a
          href="https://stripe.com/global"
          class="common-Link"
        >
          25+ countries
        </a> Je mehr du dabei von dir erzaehlst, desto ansprechender und wirkungsvoller ist die Wirkung deines Briefes. .
      </p>
    </section>
  </section>
</template>
...
.common-FlagIcon:before {
  content: '';
  display: inline-block;
  background-image: url('/img/v3/common/flagIcons.svg?57');
  width: 21px;
  height: 15px;
  margin-right: 12px;
  vertical-align: -2px;
...
.keyboard-navigation {
  ...
  .globalNav {
    ...
    .globalNav .rootLink.topNavCta--variant1:hover,
    .globalNav .rootLink.topNavCta--variant2:hover {
      color: hsla(0, 0%, 100%, 0.8);
    ...
    .globalNav .rootLink.topNavCta--variant3:hover,
    .globalNav .rootLink.topNavCta--variant4:hover {
      -webkit-transform: translateY(-1px);
      transform: translateY(-1px);
      -webkit-box-shadow: 0 7px 14px rgba(50, 50, 93, 0.1),
        0 3px 6px rgba(0, 0, 0, 0.08);
